...
\newcommand{\surrogatepolicy}[7]{%
    ...
    \node[below=0.75cm] at (0, -6) {
        \scalebox{2.5}{$\displaystyle
        \text{\ClusteringUniversalityName} = \frac{1}{\binom{n}{2}} \sum_{i=1}^{n} \sum_{j=0}^{i-1} \operatorname{\AdjustedRandIndexAcronym}(\mathcal{C}_{i}, \mathcal{C}_{j})
        $}
    };
