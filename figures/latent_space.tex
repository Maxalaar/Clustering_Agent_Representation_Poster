\begin{figure}[H]
    ...
    \begin{tikzpicture}[x=3cm,y=1cm, scale=2]
    \large
    ...
    \node[minimum height=1cm, minimum width=1cm, align=center] (distribution_label) at ($(distribution_1) + (0, 1.25cm)$) {\hl{Distribution}};
    ...
    \node[] (embedding) at ($(embedding_label) + (0, -2.5cm)$) {
        $\begin{bmatrix}
