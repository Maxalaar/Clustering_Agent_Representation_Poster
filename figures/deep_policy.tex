\begin{figure}
    ...
    \begin{tikzpicture}[x=1.75cm,y=1cm]
      ...
      \readlist\Nnod{4,5,6,6,5,3}
      \def\nstyle{1}
      \tikzset{
        node 1/.style={thick,circle,draw,minimum size=10,inner sep=0.5,outer sep=0.6},
      }
      ...
      \node[draw, rectangle, fit=(N1-1)(N3-6)(N3-1)(N6-1), inner sep=0.25cm, dashed, rounded corners=0.3cm, color=mygreen] (policy) {};
      ...
      % Distribution
      \node[minimum height=1cm, minimum width=1cm] (distribution_1) at ($(N6-1) + (1.75cm, 0)$) {\scalebox{1.25}{$\textcolor{mygreen}{d_1}$}};
      \node[minimum height=1cm, minimum width=1cm] (distribution_2) at ($(N6-2) + (1.75cm, 0)$) {\scalebox{1.25}{$\textcolor{mygreen}{d_2}$}};
      \node[minimum height=1cm, minimum width=1cm] (distribution_3) at ($(N6-3) + (1.75cm, 0)$) {\scalebox{1.25}{$\textcolor{mygreen}{d_3}$}};
      ...
      \draw[->] ($(N6-1.east) + (0.0cm, 0)$) -- ($(distribution_1.west) + (0.2cm, 0)$);
      \draw[->] ($(N6-2.east) + (0.0cm, 0)$) -- ($(distribution_2.west) + (0.2cm, 0)$);
      \draw[->] ($(N6-3.east) + (0.0cm, 0)$) -- ($(distribution_3.west) + (0.2cm, 0)$);
